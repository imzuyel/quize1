    ...
    frontend_sections: [
      {
        ...
        title: "PGTSC কুইজ অ্যারেনা ও অনলাইন এক্সাম হাব",
        subtitle: "স্মার্ট ভোকেশনাল লার্নিং ও লাইভ কুইজ প্ল্যাটফর্ম",
        description: "পঞ্চগড় সরকারি টেকনিক্যাল স্কুল ও কলেজের কুইজ অ্যারেনায় আপনাকে স্বাগতম! অনুশীলন করুন, লাইভ কুইজে অংশ নিন এবং আপনার প্রস্তুতি যাচাই করুন।",
        content: null,
        icon: "⚡",
        image: null,
        link: "/quizzes",
        buttonText: "লাইভ কুইজে যোগ দিন",
        buttonVisible: true,
        isActive: true,
        displayOrder: 1,
        visibility: "everyone",
      ...
      },
      {
        ...
        title: "দ্রুত সেবাসমূহ",
        subtitle: "সহজেই কুইজ, পিডিএফ ও ব্যাংক অ্যাক্সেস করুন",
        description: "এক ক্লিকেই লাইভ কুইজ, অনুশীলন সেট, পিডিএফ লাইব্রেরি ও প্রশ্ন ব্যাংকে নেভিগেট করুন।",
        content: null,
        icon: "🚀",
        image: null,
        link: null,
      ...
      {
        id: 3,
        sectionKey: "notice_banner",
        title: "📢 বিশেষ বিজ্ঞপ্তি: আগামী পর্বের টার্ম পরীক্ষা সংক্রান্ত",
        subtitle: "এসএসসি ও এইচএসসি ভোকেশনাল শিক্ষার্থীবৃন্দের জন্য অনলাইন মক টেস্ট প্রস্তুত।",
        description: "আপনার নিজ নিজ ট্রেড ও শ্রেণির লাইভ সেশনে নির্ধারিত সময়ে অংশ নিন।",
        content: null,
        icon: "📌",
        image: null,
        link: "/student",
        buttonText: "কুইজ সময়সূচি দেখুন",
        buttonVisible: true,
        isActive: true,
        displayOrder: 3,
        visibility: "everyone",
