  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4 xl:grid-cols-7">
        {ACTIONS.map((a, i) => (
          <ScrollReveal key={a.href} variant="fade-up" delay={i * 40} duration={500} className="scroll-animation">
            <Link href={a.href}>
              <div
      ...
      {!data ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            <ScrollReveal variant="fade-up" delay={0} duration={550} className="scroll-animation">
              <StatCard label="আমার কুইজ" value={data.totals.quizzes} icon="📚" />
            </ScrollReveal>
            <ScrollReveal variant="fade-up" delay={80} duration={550} className="scroll-animation">
              <StatCard label="গড় স্কোর" value={data.totals.averageScore} sub="সব ফলাফলের গড়" icon="🎯" tone="gold" />
            </ScrollReveal>
            <ScrollReveal variant="fade-up" delay={160} duration={550} className="scroll-animation">
              <StatCard label="অংশগ্রহণ" value={`${data.totals.participation}%`} icon="👥" tone="blue" />
            </ScrollReveal>
            <ScrollReveal variant="fade-up" delay={240} duration={550} className="scroll-animation">
              <StatCard
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <ScrollReveal variant="fade-up" className="scroll-animation lg:col-span-2" delay={80} duration={600}>
