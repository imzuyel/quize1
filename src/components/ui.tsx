...
export function Card({
  ...
  return (
    <div className={cx("pg-surface pg-shadow bg-white/90", padded && "p-5", className)}>{children}</div>
  );
}
...
const inputCls =
  "w-full rounded-xl border border-[var(--pg-line)] bg-white/90 px-3 py-2.5 text-sm outline-none transition duration-200 focus:border-[var(--pg-teal)] min-h-[44px]";
